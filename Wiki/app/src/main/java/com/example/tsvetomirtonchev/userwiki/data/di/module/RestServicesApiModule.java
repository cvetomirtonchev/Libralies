package com.example.tsvetomirtonchev.userwiki.data.di.module;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;

import com.example.tsvetomirtonchev.userwiki.BuildConfig;
import com.example.tsvetomirtonchev.userwiki.data.rest.RestServices;
import com.example.tsvetomirtonchev.userwiki.data.rest.RestServicesApi;
        ...
        Interceptor interceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                Request.Builder requestBuilder = original.newBuilder()
                        .header("demo", "ANDROID-" + BuildConfig.VERSION_NAME);
